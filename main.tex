...
\bibitem[Bott,Tu]{bott} Bott R., Tu, L.W.: \textit{Differetial forms in algebraic
  topology}, Springer Verlag, 1982.

  
\bibitem[Cheeger]{cheeger} Cheeger, J.: \textit{On the Hodge theory
  of Riemannian pseudomanifolds}, Proc. of Symp. in Pure Math. vol.36,

\bibitem[Kirwan, Woolf]{kirwan}  Kirwan, F., Woolf, J.: \textit{An Introduction
to Intersection Homology Theory}, Taylor \& Francis, LLC.

\bibitem[Kostrikin]{kostrikin} Kostrikin, A.I.: \textit{Wstęp do algebry.
...
\bibitem[Muckenhoupt]{hardys} Muckenhoupt, B., \textit{Hardy's inequality
with weights}, Studia Mathematica, T. XLIV, 1972

\bibitem[Weber]{weber}  Weber, A.: \textit{An isomorphism from
  intersection homology to $\mathrm{L}_p$-cohomology}, Forum
  Mathematicum, de Gruyer, 1995.

\bibitem[Youssin]{youssin} Youssin, B., \textit{$\mathrm{L}_p$
